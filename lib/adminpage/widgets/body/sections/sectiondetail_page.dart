                        ...
                        child: SelectionArea(
                          child: Column(
                            ...
                            children: [
                              ...
                              buildInfoText("Fullname delegation",
                                  data['full_name_delegate']),
                              ...
                              buildInfoText("Previous MUN Experience",
                                  data['previous_mun_experience']),
                              buildInfoText("Dietary Restriction",
                                  data['dietary_restriction']),
                              buildInfoText("Special Medical Condition",
                                  data['special_medical_condition']),
                              buildInfoText(
                                  "Accommodation Status", data['accom_status']),
                              const Text(
                                "Proof of Transfer",
                                style: TextStyle(
                                    color: Colors.black,
